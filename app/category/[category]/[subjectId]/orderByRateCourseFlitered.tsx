...
const SubjectOrderByRateCoursesList = ({subject}:{subject:any}) => {
  const [page, setPage] = useState<number>(1);
  const [pageSize, setPageSize] = useState<number>(4);
 

  const { data, isSuccess,isLoading,error } = useOrderCourseByRateFilterBySubjectIdQuery({ page: page.toString(), pageSize: pageSize.toString(),subjectId:subject.id });
 console.log(error)
