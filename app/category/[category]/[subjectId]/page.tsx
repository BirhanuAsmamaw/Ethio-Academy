...
<div className="p-4 md:p-6 lg:p-10 xl:p-20 w-full">
    ...
    <Link href={`/category${department?.url}`} className=" no-underline hover:underline text-xl md:text-2xl lg:3text-xl xl:text-4xl font-semibold">[{subject?.subjectName}]</Link>
    </div>
     </Banner>
     </div>
