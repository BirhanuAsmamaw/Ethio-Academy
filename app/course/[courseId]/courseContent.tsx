  ...
  return (
    <Accordion type="single" collapsible className="w-full p-1" >
      ...
      {course.chapters.map((chapter:any,index:number) =>{
        return <AccordionItem key={index} value={`${index}`}className="border bg-background   w-full  border-slate-200 dark:border-gray-600 px-2 md:px-6 m-2 rounded-[6px] ">
        <AccordionTrigger className="hover:no-underline w-full" ><div className="flex gap-2  w-full text-captalize  ">
