...
aria-expanded={dOpen}
className="w-[200px] flex gap-2 p-2 rounded-[5px] justify-between text-[14px] border bg-gray-200 dark:bg-gray-700 dark:border-gray-600 font-semibold leading-4"
>
<p>{dValue
...
aria-expanded={sOpen}
className="w-[200px] flex gap-2 justify-between text-[14px] p-2 rounded-[5px]   border bg-gray-200 dark:bg-gray-700 dark:border-gray-600 font-semibold leading-4"
>
<p>{sValue
