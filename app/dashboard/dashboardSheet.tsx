...
Dashboard
  ...
  <div className={`fixed  left-0  h-screen  bg-white dark:bg-gray-800 shadow-xl top-14 z-50 ${!isOpen?'bg-opacity-0 -translate-x-[100%]':'w-[70%] md:w-[50%] bg-opacity-100 translate-x-0'} transition duration-300 ease-in-out`}>
