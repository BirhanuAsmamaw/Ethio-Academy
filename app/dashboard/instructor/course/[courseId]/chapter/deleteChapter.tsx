...
const router=useRouter();
  ...
  <div className="w-full px-6  py-4 lg:w-8/12 space-y-4 rounded-md bg-slate-100 dark:bg-slate-900">
    <p className=' backdrop:md'>Are You Sure To Delete This Chapter?</p>
