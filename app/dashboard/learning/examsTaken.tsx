...
export const columns: ColumnDef<ExamTaken>[] = [
...
export const ExamTakenClient:React.FC<ExamTakenProps>=({exams})=> {
    ...
    <div className="w-full bg-white dark:bg-gray-800  p-4">
      <div className="flex items-center py-4">
        <Input
          ...
          value={(table.getColumn("exam")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("exam")?.setFilterValue(event.target.value)
          }
