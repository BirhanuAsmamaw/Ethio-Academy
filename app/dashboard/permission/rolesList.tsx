        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="border-gray-200 bg-gray-100 dark:bg-gray-700 dark:border-gray-600 rounded-[5px]">
            ...
            <DropdownMenuItem>
             ...
             href={`/dashboard/role-list/${role?.id}/update/role`}>Edit role Role</Link>
            </DropdownMenuItem>
            
            <DropdownMenuItem> 
              <Link 
              className="no-underline text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200" 
              href={`/dashboard/role-list/${role.id}/delete`}>Delete role</Link>
              </DropdownMenuItem>
          </DropdownMenuContent>
...
export const RolesListClient:React.FC<RolesListProps>=({roles})=> {
