...
const filteredQuestion=Questions.filter((question:any)=>question.category==="EUEE"&&question.subject===params.subject&&question.year===params.year)
  useEffect(() => {
    setMounted(true);
  }, []);
        ...
        <div className="pt-10" id="quiz">
          <div className="p-2 py-10">
            <h4 className="text-lg font-semibold border-b-2 border-dashed">
              {params.subject} in {params.year} EUEE Exams
            </h4>
          </div>
