...
const GATYearExamsClientPage:React.FC<GATYearExamsClientPageProps> = ({department,year,Questions}) => {
  ...
  if (!Questions || !Questions.length){
    return (<div className="h-screen  p-4 w-full flex justify-center items-center">
      <NoExamNotification notification={`There are No GAT Exams in ${year} Year`} url={`/exams/GAT/${department.id}`} label={`Click Here and See ${department.departmentName} GAT Exams in Others Years`}/>
    </div>)
  }
  return (<MainLayout>
