...
const RemedialYearExamsClientPage:React.FC<RemedialYearExamsClientPageProps> = ({subject,year,Questions}) => {
  ...
  if (!Questions || !Questions.length){
    return (<div className="h-screen  p-4 w-full flex justify-center items-center">
      <NoExamNotification notification={`There are No ${subject} Exams in ${year} Year`} url={`/exams/Remedial/${subject}`} label={`Click Here and See ${subject} Exams in Others Years`}/>
    </div>)
  }
  return (<MainLayout>
        ...
        <div className="pt-10" id="quiz">
          <div className="p-2 py-10">
            <h4 className="text-lg font-semibold border-b-2 border-dashed">
              {subject} in {year} Remedial Exams
            </h4>
          </div>
