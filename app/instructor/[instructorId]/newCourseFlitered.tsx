...
const InstructorNewCoursesList = ({instructorId}:{instructorId:string}) => {
  const [page, setPage] = useState<number>(1);
  const [pageSize, setPageSize] = useState<number>(4);
 

  const { data, isSuccess,isLoading } = useNewCourseFilterByInstructorQuery({ page: page.toString(), pageSize: pageSize.toString(),instructorId:instructorId });
...
export default InstructorNewCoursesList;
