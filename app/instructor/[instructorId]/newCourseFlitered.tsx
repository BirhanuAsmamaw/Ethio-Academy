...
const InstructorNewCoursesList = ({instructor}:{instructor:any}) => {
  const [page, setPage] = useState<number>(1);
  const [pageSize, setPageSize] = useState<number>(4);
 

  const { data, isSuccess,isLoading } = useNewCourseFilterByInstructorQuery({ page: page.toString(), pageSize: pageSize.toString(),instructorId:instructor.id });
