...
const ContactComponent = () => {
  return (<div className="py-3 sm:order-none order-3">
  ...
  <div>
      <div className="flex items-center my-1">
          <a className="w-6 text-gray-700 dark:text-gray-300 hover:text-orange-600"><svg
      ...
      <div className="flex items-center my-1">
          <a className="w-6 text-gray-700 dark:text-gray-300 hover:text-orange-600"
