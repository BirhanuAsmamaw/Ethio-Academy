...
{subjectCat?    <div className="p-2 absolute top-1 -left-32 opacity-0 z-10   group-hover:left-0 bg-white dark:bg-gray-800 leading-5 group-hover:opacity-100 text-sm font-medium shadow-md drop-shadow-md text-gray-600 dark:text-gray-400 bg-opacity-80 dark:bg-opacity-80 flex justify-center transition-all duration-300">
      <p>{subjectCat}</p>
    </div>:""}
