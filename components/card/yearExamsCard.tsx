...
const YearExamCard:React.FC<YearExamCardProps> = ({year,url}) => {
  ...
  return (
    <div  className="no-underline block w-full md:max-w-sm p-6 h-[200px] bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
