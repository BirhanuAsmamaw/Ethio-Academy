...
const ContactForms = () => {
  ...
  return (<div className=" space-y-8 pb-10 md:pb-0 w-full lg:w-min px-4">
    <h1 className='w-full text-xl md:text-4xl font-semibold border-b-2 border-double p-2 border-cyan-200 dark:border-gray-700  text-gray-800 dark:text-gray-100 tracking-tight !leading-tight'>Contact Us</h1>
...
<div className="w-full flex justify-end p-4">
  <button type='submit' className='rounded-full w-full md:w-20 text-center !py-1 !px-2.5 bg-blue-600 text-white hover:bg-blue-600'>Send</button>
</div>
    </form>
    </div>
