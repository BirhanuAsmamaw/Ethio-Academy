...
const FAQComponent = () => {
  return (<AnimatePresence>
    <section className="px-2 md:px-10 py-20  md:py-48 min-h-screen bg-orange-50 dark:bg-[#0d0d0d]  flex justify-center w-full">
  <motion.div
  ...
  <Accordion type="single" collapsible className="w-full p-1 mt-20 z-20 " >
