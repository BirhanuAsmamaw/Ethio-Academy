...
const SecondNavigation = ({ user }:{user:any}) => {
  ...
  return (
    <>
      {isSecondNavbar ?(
        <div className="hidden px-6 md:flex h-16 py-1 fixed w-full z-40 bg-slate-100/95 dark:bg-gray-800/95 border-b border-slate-200 dark:border-gray-600 items-center justify-between">
